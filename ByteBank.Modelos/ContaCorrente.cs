...
namespace ByteBank.Modelos
{
	...
	public class ContaCorrente
	{
		...
		/// </summary>
		/// <exception cref="ArgumentException">Exceção lançada quando um valor negativo é utilizado no argumento <paramref name="valor"/>valor</exception>
		...
		/// <param name="valor">Representa o valor do saque, deve ser maior que - e menor que o <see cref="Saldo"/>.</param>
